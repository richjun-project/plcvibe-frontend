-- PLCVibe Database Complete Reset and Migration
-- ⚠️ WARNING: This will DROP ALL TABLES and DATA, then recreate with new schema
...
CREATE INDEX idx_ladder_programs_session_id ON ladder_programs(session_id);
CREATE INDEX idx_ladder_programs_created_at ON ladder_programs(created_at DESC);
CREATE INDEX idx_validation_results_program_id ON validation_results(program_id);
